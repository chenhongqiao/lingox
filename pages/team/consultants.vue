  ...
  setup () {
    const consultants: Ref<Member[]> = ref([
      ...
      },
      {
        ...
        image: require('@/static/images/team/william.png')
      }, {
        name: 'Rey Shankar',
        ...
        image: require('@/static/images/team/anjali.jpeg')
      },
      {
        name: 'Alex Fu',
        ...
        position: 'UCLA',
        image: require('@/static/images/team/alex.jpeg')
      }
    ])
