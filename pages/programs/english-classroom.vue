          ...
          <v-card class="pa-1" flat>
            ...
            <v-card-text v-else>
              <v-form ref="form" v-model="valid">
                ...
                <v-text-field v-model="formData.school" :label="$t('form.school')" :rules="[
                v => !!v || 'School is required']" />
                <v-text-field v-model="formData.occupation" :label="$t('form.occupation')" :rules="[
                v => !!v || 'Occupation is required']" />
                <v-text-field v-model="formData.needs" :label="$t('form.needs')" :hint="$t('form.needsHint')" :rules="[
                v => !!v || 'School Needs is required']" />
                <v-text-field v-model="formData.distribution" :label="$t('form.distribution')"
                  :hint="$t('form.distributionHint')" :rules="[
                  v => !!v || 'Distribution is required']" />
                <v-text-field v-model="formData.verification" :label="$t('form.verification')"
                  :hint="$t('form.verificationHint')" :rules="[
